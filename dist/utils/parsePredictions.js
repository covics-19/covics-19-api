...
function parseCountryPrediction(prediction) {
    const resources_prediction_3w = prediction.resources_capacity - (prediction.confirmed_prediction_3w - prediction.deaths_prediction_3w - prediction.recovered_prediction_3w) / 20;
