...
function parseCountryPrediction(prediction) {
    ...
    const available_resources = prediction.resources_capacity - resources_requirements;
    const available_resources_prediction_3w = prediction.resources_capacity - resources_requirements_prediction_3w;
